...
export const MILESTONE_BADGE_SVGS = {
  ...
  m2:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">' +
    '<path fill="currentColor" d="M6 3h12v2H6V3zm0 4h12v14H6V7zm2 2v10h8V9H8zm1 1h2v2H9v-2zm3 0h2v2h-2v-2z"/></svg>',
  m3:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">' +
    '<path fill="currentColor" d="M5 4h14v2H5V4zm0 4h14v12H5V8zm2 2v8h10v-8H7zm2 2h6v2H9v-2zm0 4h6v2H9v-2z"/></svg>',
  m4:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">' +
